...
enum PaddrStyle {
    ...
    enum Metrics {
        ...
        static let minimumWindowSize = NSSize(width: 680, height: 600)
        /// Permission cards share a row while each still has room for its status and actions.
        static let permissionColumnsBreakpoint: CGFloat = 960
